...
class Main extends Component {
    ...
    this.state = {
      ...
      energy_data_details: [{
        ...
        data1: {
          ...
          datasets: [{
            label: "Billions of Lightbulb Units In Other Cities",
            backgroundColor: ["rgba(236,50,58,0.5)", "rgba(236,50,58,0.5)", "rgba(236,50,58,0.5)", "rgba(236,50,58,0.5)", "rgba(33,141,167,0.5)"],
            hoverBackgroundColor: ["rgba(236,50,58,0.3)", "rgba(236,50,58,0.3)", "rgba(236,50,58,0.3)", "rgba(236,50,58,0.3)", "rgba(33,141,167,0.3)"],
            data: [
              (50.7), (8.1),
              (29.2),
              (18.1),
  ...
  citySavedText() {
    if(this.state.city_energy_cost < this.state.city_energy_budget) {
      return " electricity costs saved ";
    } else {
      return " extra electricity costs paid ";
    }
  }
    ...
    return (
      <ProgressBarContainer section="section2Introduction" progress="city">
        ...
        <div style={{fontSize: Metric.font.size.extraLarge, fontWeight: Metric.font.weight.medium}}>
          We have seen how energy choices affect your home, <br />what happens when we make energy choices for our city?
        </div>
  ...
  renderSection2Quiz2() {
    return (
      <ProgressBarContainer section="section2Quiz2" progress="city">
        ...
        <div style={styles.universal.largeFont_reg}>
          Now imagine the mayor of your city asks you to choose an energy source portfolio that would save the city the most money possible. What would you choose?
        </div>
        ...
        <div style={this.state.shouldHide ? {display: 'none'} : styles.universal.grey_box }>
          ...
          <div className="row ">
           ...
           <span className="col-sm-4" style={{padding: "0 10px"}}>
            ...
            (1 KWH = 16.7 <img alt=""src={Image.lightbulb.small}/> )
          </span>
        </div>
